...
customer_entry = tk.Entry(root, bg=entry_bg)
...
pizza_var.trace_add("write", update_cost_display)
pizza_menu = tk.OptionMenu(root, pizza_var, *prices.keys())
pizza_menu.grid(row=1, column=1, padx=10, pady=5)
...
size_var.set("Small")
size_var.trace_add("write", update_cost_display)
size_menu = tk.OptionMenu(root, size_var, "Small", "Medium", "Large")
size_menu.grid(row=2, column=1, padx=10, pady=5)
...
quantity_menu.grid(row=3, column=1, padx=10, pady=5)
...
order_list.grid(row=7, column=0, columnspan=2, padx=10, pady=10)
...
delete_customer_menu.grid(row=8, column=1, padx=10, pady=5)
delete_button = tk.Button(root, text="Delete Order", command=delete_order, bg=button_bg, fg=button_fg)
